...
class TestShowcase(unittest.TestCase):
    ...
    def test_showcase(self):
        ...
        if record:
            ...
            context = Context('Showcase', include_start=False, initial_weight=0.2)
        ...
        context.add_definition('tomato', 'a red or yellow fruit with a juicy pulp')
        context.add_definition('sausage', 'a mixture of chopped meat and spices stuffed')
        ...
        context.stimulate_sequence('I am very hungry, I need to eat, I think I need a salad or something lite')
