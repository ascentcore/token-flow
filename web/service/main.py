...
initial_weight = 0.739
weight_increase = 0.013
temp_decrease = 0.01
neuron_opening = 0.153


dataset.add_context(Context('Red Riding Hood', vocabulary,
                            initial_weight=initial_weight,
                            weight_increase=weight_increase,
                            neuron_opening=neuron_opening,
                            temp_decrease=temp_decrease))

# dataset.add_context(Context('Three Little Pigs', vocabulary,
#                             initial_weight=initial_weight,
#                             weight_increase=weight_increase,
#                             neuron_opening=neuron_opening,
#                             temp_decrease=temp_decrease))
